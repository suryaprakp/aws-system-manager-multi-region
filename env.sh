...
SCRIPT_DIR_AWS_CONFIG_A334A97D8979="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"
...
if [ -d "${SCRIPT_DIR_AWS_CONFIG_A334A97D8979}/bin" ]; then
    export PATH="${SCRIPT_DIR_AWS_CONFIG_A334A97D8979}/bin:$PATH"
fi